...
# FROZEN PATH: Makefile references scripts/e2e.sh — do not move/rename.
# Single command from REPO ROOT:  bash scripts/e2e.sh
...
# ---- cwd-robust: repo root IS the server dir; run from there ----
